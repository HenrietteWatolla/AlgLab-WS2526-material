...
class Instances:
    ...
    def generate_test_instances():
        ...
        # dense graphs --> number of edges is close to the maximal number of edges
        ...
        # erdos_renyi_graph(number of nodes, probability that an edge between two nodes exist, seed that guarantee same graph for same input)
        ...
        # barabasi_albert_graph(number of nodes, edges added per new node, seed)
    ...
    def load_dimacs_instances():
        ...
        dimacs_dir = os.path.join(base_dir, "..", "dimacs_instances")
    ...
    def graph_classes():
        ...
        classes = {
            ...
            "dimacs": [name for name, i in instances if name.startswith("DIMACS_")]
        }
        return classes